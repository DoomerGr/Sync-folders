...
type
  ...
  TFmConfig = class(TForm)
    ...
    RzLabel5: TRzLabel;
    RzPanel2: TRzPanel;
    RadioButtonShabNone: TRadioButton;
    RadioButtonShabYes: TRadioButton;
...
begin
 ...
 with ProfilLine do
  begin
   ...
   if RadioButtonShabNone.Checked then PropuskShablon:=true else PropuskShablon:=false;
     ...
     begin
       ...
       with ProfilLine do
        begin
         ...
         if PropuskShablon=true then RadioButtonShabNone.Checked else
         RadioButtonShabYes.Checked;
